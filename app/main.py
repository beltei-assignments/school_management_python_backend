...
from app.routers import user_route, auth_route, subject_route, class_router, role_route, schedule_route  
...
app.include_router(schedule_route.router, prefix=prefix)
